...
class TestSparseStructureFlowModel:
    def test_sparse_flow_gelu_matches_pytorch_mps_bf16_fixture(self):
        """Anchor the TRELLIS MLP GELU to PyTorch MPS bf16 tanh-GELU behavior."""
        import numpy as np
        ...
        out = np.array(_gelu_tanh(x).astype(mx.float32))
